...
// ============================================
// Floating Help / FAQ Widget
// Pixel-perfect replica of Shopify faq-help-widget.liquid
// ============================================
  ...
  const faqs = [
    {
      ...
      answer: 'We deliver within 2-4 business days across India. For same-city orders, delivery can be as fast as same-day or next-day! You\'ll receive a tracking link once your order is dispatched.'
    },
    {
      question: 'Can I customize my gift?',
      answer: 'Absolutely! Most of our products can be personalized with names, photos, or custom messages. Just select the customization option on the product page and share your details. We\'ll make it special for you! 💝'
    },
    {
      question: 'What payment methods do you accept?',
      answer: 'We accept UPI (GPay, PhonePe, Paytm), all debit/credit cards, net banking, and Cash on Delivery (COD) for selected areas. All payments are 100% secure.'
    },
    {
      question: 'What is your return/exchange policy?',
      answer: 'If you receive a damaged or incorrect item, just contact us within 24 hours with photos. We\'ll arrange a replacement or full refund immediately. Your happiness is our priority!'
    },
    {
      question: 'Do you deliver on festivals & Sundays?',
      answer: 'Yes! We deliver on all festivals, weekends, and special occasions. In fact, festival days are our busiest! Just place your order 1-2 days in advance to guarantee on-time delivery. 🎉'
    }
  ];
    ...
    <>
      ...
      <style>{`
        ...
        .faq-fab-btn::before {
          ...
          animation: faqPulseRing 3s ease-in-out infinite;
          pointer-events: none;
        }
        .faq-dialog-body::-webkit-scrollbar { width: 3px; }
        .faq-dialog-body::-webkit-scrollbar-track { background: transparent; }
        .faq-dialog-body::-webkit-scrollbar-thumb { background: #ddd; border-radius: 4px; }
      `}</style>
      ...
      >
        ...
        {/* FAQ Body - scrollable */}
        <div className="faq-dialog-body" style={{
          flex: 1,
          overflowY: 'auto',
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <div key={index} style={{
                borderBottom: index < faqs.length - 1 ? '1px solid #f3f3f3' : 'none',
              }}>
                <button
                ...
                >
                  ...
                  <span style={{
                    ...
                    height: '22px',
                    borderRadius: '50%',
                    background: isExpanded ? '#1a1a1a' : '#f5f5f5',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    ...
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
                      stroke={isExpanded ? '#fff' : '#666'} strokeWidth={2.5} strokeLinecap="round">
                ...
                <div style={{
                  ...
                  padding: isExpanded ? '0 6px 14px' : '0 6px',
                }}>
                  <p style={{
                    fontFamily: "'Outfit', sans-serif",
                    fontSize: '0.82rem',
      ...
      <button
        ...
        onMouseEnter={(e) => { if (!isOpen) { e.currentTarget.style.transform = 'scale(1.08)'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(0,0,0,0.22)'; }}}
        onMouseLeave={(e) => { if (!isOpen) { e.currentTarget.style.transform = 'scale(1)'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(0,0,0,0.18), 0 2px 8px rgba(0,0,0,0.12)'; }}}
      >
