...
const categories = [
    { name: 'Anniversary', image: '/hearts/anniversary.jpg', slug: 'anniversary' },
    { name: 'Romantic Flowers', image: '/hearts/romantic.jpg', slug: 'romantic-flowers' },
    { name: 'Wedding', image: '/hearts/wedding.webp', slug: 'wedding-gifts' },
    { name: 'Gifts To Say Sorry', image: '/hearts/sorry.webp', slug: 'gifts-to-say-sorry' },
    { name: 'Thinking Of Someone', image: '/hearts/thinking.jpg', slug: 'thinking-of-someone' },
    { name: 'For Girlfriend', image: '/hearts/girlfriend.webp', slug: 'for-girlfriend' },
    { name: 'For Boyfriend', image: '/hearts/boyfriend.webp', slug: 'for-boyfriend' },
    { name: 'Missing Someone', image: '/hearts/missyou.webp', slug: 'miss-you' },
];
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="grid md:hidden grid-rows-2 grid-flow-col auto-cols-[140px] overflow-x-auto gap-x-4 gap-y-6 pb-4 no-scrollbar -mx-4 px-4 snap-x snap-mandatory">
                        {categories.map((cat, idx) => (
                            <a key={idx} href={`https://shop.themaryam.in/collections/${cat.slug}`} className="flex flex-col items-center gap-2 snap-center">
                    ...
                    <div className="hidden md:grid grid-cols-4 gap-y-20 gap-x-10 lg:gap-x-16">
                        {categories.map((cat, idx) => (
                            <a key={idx} href={`https://shop.themaryam.in/collections/${cat.slug}`} className="flex flex-col items-center gap-4 group cursor-pointer no-underline">
